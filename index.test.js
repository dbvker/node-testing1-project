...
describe('[Exercise 3] findLargestInteger', () => {
  test('[5] returns the largest number in an array of objects { integer: 2 }', () => {
    const input1 = [ { integer: 1 }, { integer: 30}, { integer: 2 } ]
    const input2 = [ { integer: 3 }, { integer: 1}, { integer: 20 } ]
    const input3 = [ { integer: 10 }, { integer: 2}, { integer: 3 } ]
    ...
    expect(actual1).toBe(30);
    expect(actual2).toBe(20);
    expect(actual3).toBe(10);
  })
})
